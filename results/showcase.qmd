...
print(f"Dataframe Length: {len(gdf_track_info)} Rows")
```
...
display(gdf_track_info_multiples_combined.head(5))
print(f"Dataframe Length: {len(gdf_track_info_multiples_combined)} Rows")
```
...
# gdf_track_info_stc = gdf_track_info[gdf_track_info["region"] != "Other"]
# gdf_track_info_stc.set_geometry("start_point").to_crs(3857).plot("region", ax=ax, legend=True, marker='o', s=2)
